...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable('Disputes', {
      ...
      resolution_details: { type: Sequelize.TEXT, allowNull: true },      resolved_by_user_id: { // User ID of admin who resolved
    ...
    await queryInterface.addIndex('Disputes', ['priority'], { name: 'disputes_priority_idx' });
    ...
    await queryInterface.addIndex('Disputes', ['resolved_at'], { name: 'disputes_resolved_at_idx' });  },
  async down(queryInterface, Sequelize) {
    ...
    await queryInterface.removeIndex('Disputes', 'disputes_priority_idx');
    await queryInterface.removeIndex('Disputes', 'disputes_status_idx');
    await queryInterface.removeIndex('Disputes', 'disputes_resolved_at_idx');
